# Student Guide: fleet-midi-groove

_Learn how the groove agent works and how to use it._

---

## What You'll Learn

1. What the groove musical concept is
2. How ternary decomposition applies to groove
...
```bash
curl -s http://localhost:2170/health | python3 -m json.tool
```
...
```bash
curl -s -X POST http://localhost:2170/agent \
